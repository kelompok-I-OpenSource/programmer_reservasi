...
<!-- menambahkan video di halaman awal -->
<section id="hero" style="position: relative;">
  ...
  <!--ubah posisi judul home--->
  <div class="hero container" style="position: relative; z-index: 1; text-align:left; margin-left: 10px;">
    <div>
      <h1><strong>
          <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> ANGELATO</h1><span></span>
        </strong></h1>
      <h1><strong style="color:white;">
          Resto
          &<span></span></strong></h1>
      <h1><strong style="color:white;">
          Cafe<span></span></strong></h1>
      ...
      <div class="mainDish">
        ...
        <?php foreach ($mainDishes as $item): ?>
          <p>
            ...
            <span class="item-price">Rp<?php echo $item['item_price']; ?></span><br>
...
<section id="about" ">
  ...
  <div class="col-right">
    ...
    <h2>Angelato DINING & BAR Company History:</h2>
    <p>Angelato Dining & Bar is a well-established Western food establishment in the city's heart. Angelato Dining & Bar has become a popular choice for customers looking to celebrate special occasions or simply enjoy a relaxing meal, with a focus on providing delicious meals and a friendly dining experience.
    </p>
    <p>Angelato Dining & Bar, as a Western restaurant, offers a diverse menu that caters to a variety of tastes. The menu includes a wide range of options such as bar bites, salads, soups and a variety of main courses. Customers can savour succulent options such as steak and ribs, chicken, lamb, seafood, burgers and sandwiches, pasta, and a variety of delectable side dishes. The menu has been carefully curated to offer a balance of classic favourites and innovative creations, ensuring that every palate is satisfied.
    </p>
    <p>Angelato Dining & Bar's ability to accommodate customers is one of its distinguishing features. Angelato Dining & Bar strives to create an inviting and comfortable dining environment, whether guests prefer to walk in or make reservations in advance. The restaurant recognises the significance of creating memorable experiences, particularly for those celebrating special occasions. Angelato Dining & Bar is a popular choice for families, couples, and groups of friends because of its attentive staff and welcoming atmosphere.
    </p>
    <p>Angelato Dining & Bar has an inviting outdoor bar that is open seven days a week from 11:00 AM to 10:00 PM in addition to the indoor dining area.This outdoor space provides a relaxed setting for patrons to unwind and socialise while sipping on their favourite drinks and nibbling on bar bites. The bar serves a wide range of beverages, including cocktails, wines, beers and non-alcoholic options.
    </p>
