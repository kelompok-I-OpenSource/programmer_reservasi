...
class PDF extends FPDF
{
    function Header()
    {
        ...
        $this->Cell(0, 10, "Angelato Dining & Bar Report", 0, 1, 'C');
...
$pdf->ChapterBody("Total Revenue Today: Rp " . number_format($totalRevenueToday, 2));
$pdf->Ln();
...
$pdf->ChapterBody("Total Revenue This Week: Rp " . number_format($totalRevenueThisWeek, 2));
$pdf->Ln();
...
$pdf->ChapterBody("Total Revenue This Month: Rp " . number_format($totalRevenueThisMonth, 2));
$pdf->Ln();
...
$pdf->ChapterBody("Total Revenue This Year: Rp " . number_format($totalRevenueThisYear, 2));
$pdf->Ln();
...
$header = array('Date', 'Day', 'Revenue (Rp)');
$data = array();
...
$header = array('Date', 'Week', 'Revenue (Rp)');
$data = array();
...
$header = array('Date', 'Month', 'Revenue (Rp)');
$data = array();
...
$header = array('Date', 'Day', 'Item Category', 'Revenue (Rp)');
$data = array();
while ($row = mysqli_fetch_assoc($dailyCategoryRevenue)) {
...
$header = array('Date', 'Week', 'Item Category', 'Revenue (Rp)');
$data = array();
while ($row = mysqli_fetch_assoc($weeklyCategoryRevenue)) {
...
$header = array('Date', 'Month', 'Item Category', 'Revenue (Rp)');
$data = array();
while ($row = mysqli_fetch_assoc($monthlyCategoryRevenue)) {
...
$header = array('Date', 'Item Category', 'Revenue (Rp)');
$data = array();
