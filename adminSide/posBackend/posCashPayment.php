            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <div class="text-right">
                        <?php
                        echo "<strong>Total:</strong> Rp " . number_format($cart_total, 2) . "<br>";
                        echo "<strong>Tax (10%):</strong> Rp " . number_format($cart_total * $tax, 2) . "<br>";
                        $GRANDTOTAL = $tax * $cart_total + $cart_total;
                        echo "<strong>Grand Total:</strong> Rp " . number_format($GRANDTOTAL, 2);
                        ?>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        if (isset($_GET['payment_amount'])) {
                            ...
                            if ($payment_amount >= $GRANDTOTAL) {
                                ...
                                echo "Change is Rp" . number_format(calculateChange($payment_amount, $GRANDTOTAL), 2);
                                echo '</div>';
