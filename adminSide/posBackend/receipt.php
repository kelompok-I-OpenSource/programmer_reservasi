...
// Header
$pdf->Cell(0, 10, "Angelato Restaurant", 0, 1, 'C');
...
while ($item_row = mysqli_fetch_assoc($items_result)) {
    ...
    $pdf->Cell(40, 10, 'Rp ' . number_format($item_price, 2), 1);
    $pdf->Cell(40, 10, $quantity, 1);
    $pdf->Cell(40, 10, 'Rp ' . number_format($total, 2), 1);
    $pdf->Ln();
}
...
$pdf->Cell(40, 10, 'Rp ' . number_format($before_tax, 2), 1);
$pdf->Ln();

$pdf->Cell(150, 10, 'Tax (' . ($tax_rate * 100) . '%)', 1);
$pdf->Cell(40, 10, 'Rp ' . number_format($tax_amount, 2), 1);
$pdf->Ln();

$pdf->Cell(150, 10, 'Grand Total', 1);
$pdf->Cell(40, 10, 'Rp ' . number_format($after_tax, 2), 1);
$pdf->Ln();
