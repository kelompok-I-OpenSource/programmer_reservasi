...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // User-provided input
    $provided_account_id = $_POST['admin_id']; // 531423032
    $provided_password = $_POST['password']; // 12345678
    $uniqueString = $provided_account_id . $provided_password;

    if ($uniqueString == "53142303212345678") {
        echo ' Correct';
    ...
    <div class="login-container">
        <div class="login_wrapper">
            <div class="wrapper">
                ...
                <h5>Admin Credentials needed to Delete Staff</h5>
                <form action="" method="post">
                    ...
                    <button class="btn btn-light" type="submit" name="submit" value="submit">Delete Staff</button>
